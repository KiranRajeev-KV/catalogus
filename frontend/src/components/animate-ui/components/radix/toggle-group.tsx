...
function ToggleGroup({
	...
	return (
		<ToggleGroupPrimitive
			...
			data-size={size}
			className={cn(
				"group/toggle-group flex gap-0.5 w-fit items-center rounded-lg data-[variant=outline]:shadow-xs data-[variant=outline]:border data-[variant=outline]:p-0.5 dark:bg-input/30 dark:hover:bg-input/50",
				className,
			)}
			{...props}
		>
