...
function RouteComponent() {
	return (
		<div className="flex h-[80vh] w-full flex-col items-center justify-center gap-2 p-4 text-center">
			...
			>
				<h1 className="text-3xl font-bold tracking-tight">Stats Dashboard</h1>
				<p className="text-muted-foreground text-lg">
					We are currently crunching the numbers and building the charts. Check
					back soon for insights into your watching habits!
				</p>
			</motion.div>
